...
function createProjectModal() {
  ...
  function handleAddProject() {
    ...
    if (projectTitle === "") {
      ...
      const newProject = new _projects__WEBPACK_IMPORTED_MODULE_0__.Projects(projectTitle);
  ...
  function handleNewTask(e) {
    ...
    if (isFormValid(taskTitle, taskDescription, taskDate, taskPriority)) {
      const newTask = new _todo__WEBPACK_IMPORTED_MODULE_1__.Todo(taskTitle, taskDescription, taskDate, taskPriority);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addProjectModal);
...
class Projects {
  ...
  filterTodosByToday() {
    ...
    const formattedToday = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(today, 'yyyy-MM-dd');
  ...
  filterTodosByWeek() {
    ...
    return this.todos.filter((todo) => {
      const formattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate, 'yyyy-MM-dd');
